...
class CreatestoreCrossDeviceCollectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('store_cross_device_collections', function (Blueprint $table) {
        ...
        $this->updateTimestampDefaultValue('store_cross_device_collections', ['updated_at'], ['created_at']);
    }
    ...
    {
        Schema::dropIfExists('store_cross_device_collections');
    }
}
