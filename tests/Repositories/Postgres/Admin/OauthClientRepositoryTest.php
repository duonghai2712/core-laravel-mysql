...
class OauthClientRepositoryTest extends TestCase
{
    ...
    {
        /** @var  \App\Repositories\Postgres\Admin\OauthClientRepositoryInterface $repository */
        $repository = \App::make(\App\Repositories\Postgres\Admin\OauthClientRepositoryInterface::class);
