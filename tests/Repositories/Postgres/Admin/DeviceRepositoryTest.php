...
class DeviceRepositoryTest extends TestCase
{
    ...
    {
        /** @var  \App\Repositories\Postgres\Admin\DeviceRepositoryInterface $repository */
        $repository = \App::make(\App\Repositories\Postgres\Admin\DeviceRepositoryInterface::class);
